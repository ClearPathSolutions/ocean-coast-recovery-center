        ...
        <div className="container-wide relative z-10 pt-36 pb-20 lg:pt-48">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <a href={site.phoneHref} className="btn-primary text-base" suppressHydrationWarning>
        ...
        <div className="container-x relative z-10 text-center">
          <Reveal className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a href={site.phoneHref} className="btn-primary" suppressHydrationWarning><Phone className="h-4 w-4" /> {site.phone}</a>
